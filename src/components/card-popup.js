...
export const getCardPopupTemplate = (film, comments) => {
  const {poster, name, nameOrigin, pegi, rating, director, screenwriter, actor, fullDate, duration, country, fullDescription, genre} = film;
