// import {getRandomArrayItem, getRandomArrayItems, getRandomNumber, getRandomIntegerNumber, getRandomDate} from "../utils/utils";
//
...
//     fullDate: getRandomDate(new Date(1888, 0, 1), today, true),
